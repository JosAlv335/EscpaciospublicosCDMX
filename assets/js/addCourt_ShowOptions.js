...
chkClass.addEventListener('change',function(){
...
chkTrain.addEventListener('change',function(){
...
chkVest.addEventListener('change',function(){
...
chkWC.addEventListener('change',function(){
...
chkShowers.addEventListener('change',function(){
...
chkSauna.addEventListener('change',function(){
...
chkHidMas.addEventListener('change',function(){
